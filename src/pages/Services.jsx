    ...
    <div className="font-sans text-gray-800">
      ...
      <section className="relative h-[600px] lg:h-[700px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full lg:w-[45%] bg-white rounded-tr-[5rem] p-8 lg:p-20 pt-20 lg:pt-32">
            <h1 className="text-5xl lg:text-7xl font-light text-gray-900 mb-6">Nos Services</h1>
            <p className="text-gray-500 text-lg leading-relaxed max-w-md">
                Découvrez notre gamme complète de soins dentaires pour toute la famille.
            </p>
        </div>
      </section>
            ...
            <div className="flex flex-col lg:flex-row gap-8 h-auto lg:h-[600px]">
                ...
                <div className="lg:w-1/2 bg-accent-50 rounded-[3rem] p-12 lg:p-20 flex flex-col justify-center">
                    ...
                    <h2 className="text-4xl lg:text-6xl font-light text-gray-900 mb-8 leading-tight">
                        Retrouvez le sourire <br/> grâce aux <br/> implants dentaires
                    </h2>
                    <p className="text-gray-600 text-lg leading-relaxed mb-12 max-w-md">
                        Notre équipe d'experts en implantologie vous accompagne pour restaurer votre sourire avec des solutions durables et esthétiques.
                    </p>
                    <div>
