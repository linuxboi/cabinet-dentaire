    ...
    const doctors = [
        {
            ...
            role: t('teamPage.roles.esthetic'),
            image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&w=800&q=80'
        },
        {
            name: 'Dr. Sarah Alami',
            role: t('teamPage.roles.preventive'),
            image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=800&q=80'
        },
        {
            name: 'Dr. Karim Tazi',
            role: t('teamPage.roles.orthodontics'),
            image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&w=800&q=80'
        },
        {
            name: 'Dr. Leila Berrada',
            role: t('teamPage.roles.specialized'),
                    ...
                    <div className="flex flex-col lg:flex-row items-center">
                        ...
                        <div className="lg:w-1/2 py-12 lg:py-0">
                            <div className="bg-white p-8 lg:p-16 rounded-[3rem] shadow-xl max-w-xl relative z-20">
                                <h1 className="text-5xl lg:text-7xl font-light text-gray-900 mb-8">{t('teamPage.hero.title')}</h1>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-1/2 bg-primary-600 rounded-[3rem] p-12 lg:p-20 text-white flex flex-col justify-center relative overflow-hidden">
                            <div className="relative z-10">
                                <h2 className="text-4xl lg:text-5xl font-light mb-8 leading-tight" dangerouslySetInnerHTML={{ __html: t('teamPage.cta.title') }} />
